...
DigitalKanera uses this template under assets/story/ so legal pages can keep
../assets/style.css. Homepage restyle lives in css/studio.css. Default scenic
photos and index-demo.html are not shipped.
